...
public class scatter extends ghostState {
    public scatter(Image image, BoundingBox boundingBox, KinematicState kinematicState, GhostMode ghostMode, Vector2D targetCorner, PositionGetter posGetter, NewGhost client) {
    ...
    protected void stateTransfer() {
        ...
        this.client.setGhostMode(GhostMode.CHASE);
    }
